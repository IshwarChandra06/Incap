...
public class CosecTransactionUtil {
	...
	public String transactionAutoSyncToCosec(String empId, Date date, int accessType) throws Exception {
		...
		String myurl = ApplicationConstants.HTTP_COLON_DOUBLE_SLASH + cosecHostUrl+ CosecDeviceConstants.TRANSACTION_API_SYNC.formatted(datetime, empId, accessType);
	...
	public String transactionSendToCosec(Transaction transaction) throws Exception {
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat(
				ApplicationConstants.DATE_TIME_FORMAT_OF_INDIA_WITHOUT_DELIMITER);
		String datetime = dateFormat.format(transaction.getPunchDate());
		String myurl = ApplicationConstants.HTTP_COLON_DOUBLE_SLASH + cosecHostUrl
				+ CosecDeviceConstants.TRANSACTION_API_SYNC.formatted(datetime, transaction.getEmpId(), accessType);
		HttpGet request = getHttpGetRequest(userName, pass, myurl);
		String responeData = requestExecutionUtil.executeHttpGetRequest(request);
		System.out.println(responeData);
		return responeData;
	...
	public String getEmployeeFromCosec() {
		try {
			...
			String myurl = ApplicationConstants.HTTP_COLON_DOUBLE_SLASH + cosecHostUrl
					+ CosecDeviceConstants.EMPLOYEE_API_SEARCH.formatted(empId);
			HttpGet request = getHttpGetRequest(userName, pass, myurl);
			String responeData = requestExecutionUtil.executeHttpGetRequest(request);
			return responeData;
		} catch (Exception e) {
